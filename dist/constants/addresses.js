...
const emptyAddressList = {
    ...
    [chains_1.ChainId.BASE]: constants_1.AddressZero,
    [chains_1.ChainId.POLYGON]: constants_1.AddressZero,
    [chains_1.ChainId.RINKEBY]: constants_1.AddressZero,
    [chains_1.ChainId.SCROLL_MAINNET]: constants_1.AddressZero,
...
exports.FACTORY_ADDRESS = {
    ...emptyAddressList,
    [chains_1.ChainId.MAINNET]: _contracts_json_1.mainnet.factory,
    [chains_1.ChainId.RINKEBY]: _contracts_json_1.rinkeby.factory,
    [chains_1.ChainId.ARBITRUM_ONE]: _contracts_json_1.arbitrumOne.factory,
    [chains_1.ChainId.ARBITRUM_RINKEBY]: _contracts_json_1.arbitrumRinkebyTestnet.factory,
    [chains_1.ChainId.ARBITRUM_GOERLI]: _contracts_json_1.arbitrumGoerliTestnet.factory,
    [chains_1.ChainId.XDAI]: _contracts_json_1.xdai.factory,
    [chains_1.ChainId.GOERLI]: _contracts_json_1.goerli.factory,
};
/**
...
exports.ROUTER_ADDRESS = {
    ...emptyAddressList,
    [chains_1.ChainId.RINKEBY]: _contracts_json_2.rinkeby.router,
    [chains_1.ChainId.MAINNET]: _contracts_json_2.mainnet.router,
    [chains_1.ChainId.XDAI]: _contracts_json_2.xdai.router,
    [chains_1.ChainId.ARBITRUM_ONE]: _contracts_json_2.arbitrumOne.router,
    [chains_1.ChainId.ARBITRUM_RINKEBY]: _contracts_json_2.arbitrumRinkebyTestnet.router,
    [chains_1.ChainId.ARBITRUM_GOERLI]: _contracts_json_2.arbitrumGoerliTestnet.router,
    [chains_1.ChainId.GOERLI]: _contracts_json_2.goerli.router,
};
/**
...
exports.STAKING_REWARDS_FACTORY_ADDRESS = {
    ...emptyAddressList,
    [chains_1.ChainId.MAINNET]: '0x156F0568a6cE827e5d39F6768A5D24B694e1EA7b',
    [chains_1.ChainId.RINKEBY]: '0x0f9E49d473B813abe33F1BAB11fa9E16eE850EBa',
    [chains_1.ChainId.XDAI]: '0xa039793Af0bb060c597362E8155a0327d9b8BEE8',
    [chains_1.ChainId.ARBITRUM_ONE]: '0xecA7F78d59D16812948849663b26FE10E320f80C',
    [chains_1.ChainId.ARBITRUM_RINKEBY]: '0x41e657cAdE74f45b7E2F0F4a5AeE0239f2fB4E1F',
    [chains_1.ChainId.ARBITRUM_GOERLI]: '0x95Bf186929194099899139Ff79998cC147290F28',
};
/**
 * List of the Swapr Staking Factory contract address for each chain
 */
exports.SWPR_CLAIMER_ADDRESS = {
    ...emptyAddressList,
    [chains_1.ChainId.RINKEBY]: '0x6D525E4115d339aD4e336bCF4C85A1Fb8f4a594C',
    [chains_1.ChainId.ARBITRUM_RINKEBY]: '0x99583f330814E04de96C0288FBF82B5E35A009dc',
...
exports.SWPR_CONVERTER_ADDRESS = {
    ...emptyAddressList,
    [chains_1.ChainId.ARBITRUM_ONE]: '0x2b058af96175A847Bf3E5457B3A702F807daDdFd',
};
/**
...
exports.MULTICALL2_ADDRESS = {
    ...
    [chains_1.ChainId.BASE]: '0xca11bde05977b3631167028862be2a173976ca11',
    ...
    [chains_1.ChainId.SCROLL_MAINNET]: '0xcA11bde05977b3631167028862bE2a173976CA11',
