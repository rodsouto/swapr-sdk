...
class Fetcher {
     ...
     */
    static async fetchPairData(tokenA, tokenB, provider = (0, providers_1.getDefaultProvider)((0, networks_1.getNetwork)(tokenA.chainId)), platform = routable_platform_1.UniswapV2RoutablePlatform.SWAPR) {
        ...
        const [reserves0, reserves1] = await new contracts_1.Contract(address, IDXswapPair_json_1.default.abi, provider).getReserves();
        ...
        const swapFee = jsbi_1.default.BigInt(await new contracts_1.Contract(liquidityToken.address, IDXswapPair_json_1.default.abi, provider).swapFee());
        const protocolFeeDenominator = jsbi_1.default.BigInt(await new contracts_1.Contract(constants_1.FACTORY_ADDRESS[tokenAmountA.token.chainId], IDXswapFactory_json_1.default.abi, provider).protocolFeeDenominator());
     ...
     * @param provider the provider to use to fetch the data
     */
    static async fetchSwapFee(liquidityToken, provider = (0, providers_1.getDefaultProvider)((0, networks_1.getNetwork)(liquidityToken.chainId))) {
        return {
            fee: jsbi_1.default.BigInt(await new contracts_1.Contract(liquidityToken.address, IDXswapPair_json_1.default.abi, provider).swapFee()),
            owner: await new contracts_1.Contract(constants_1.FACTORY_ADDRESS[liquidityToken.chainId], IDXswapFactory_json_1.default.abi, provider).feeToSetter(),
        };
    }
    /**
     ...
     * @param provider the provider to use to fetch the data
     */
    static async fetchSwapFees(liquidityTokens, provider = (0, providers_1.getDefaultProvider)((0, networks_1.getNetwork)(liquidityTokens[0].chainId))) {
     ...
     * @param provider the provider to use to fetch the data
     */
    static async fetchAllSwapFees(chainId, swapFeesCache = {}, provider = (0, providers_1.getDefaultProvider)((0, networks_1.getNetwork)(chainId))) {
     ...
     * @param provider the provider to use to fetch the data
     */
    static async fetchProtocolFee(chainId, provider = (0, providers_1.getDefaultProvider)((0, networks_1.getNetwork)(chainId))) {
        const factoryContract = await new contracts_1.Contract(constants_1.FACTORY_ADDRESS[chainId], IDXswapFactory_json_1.default.abi, provider);
