...
class Token extends currency_1.Currency {
    ...
    static WETH = {
        ...
        [constants_1.ChainId.BASE]: new Token(constants_1.ChainId.BASE, '0x4200000000000000000000000000000000000006', 18, 'WETH', 'Wrapped Ether'),
        ...
        [constants_1.ChainId.SCROLL_MAINNET]: new Token(constants_1.ChainId.SCROLL_MAINNET, '0x5300000000000000000000000000000000000004', 18, 'WETH', 'Wrapped Ether on Scroll'),
        ...
        [constants_1.ChainId.ZK_SYNC_ERA_MAINNET]: new Token(constants_1.ChainId.ZK_SYNC_ERA_MAINNET, '0x5aea5775959fbc2557cc8789bc1bf90a239d9a91', 18, 'WETH', 'Wrapped Ether on zkSync'),
        /**
         ...
         */
        [constants_1.ChainId.ZK_SYNC_ERA_TESTNET]: new Token(constants_1.ChainId.ZK_SYNC_ERA_TESTNET, '0x20b28b1e4665fff290650586ad76e977eab90c5d', 18, 'WETH', 'Wrapped Ether on zkSync Testnet'),
    };
    static WMATIC = {
    ...
    static NATIVE_CURRENCY_WRAPPER = {
        ...
        [constants_1.ChainId.OPTIMISM_GOERLI]: Token.WETH[constants_1.ChainId.OPTIMISM_GOERLI],
        [constants_1.ChainId.OPTIMISM_MAINNET]: Token.WETH[constants_1.ChainId.OPTIMISM_MAINNET],
        [constants_1.ChainId.BASE]: Token.WETH[constants_1.ChainId.BASE],
        ...
        [constants_1.ChainId.SCROLL_MAINNET]: Token.WETH[constants_1.ChainId.SCROLL_MAINNET],
        [constants_1.ChainId.ZK_SYNC_ERA_MAINNET]: Token.WETH[constants_1.ChainId.ZK_SYNC_ERA_MAINNET],
        [constants_1.ChainId.ZK_SYNC_ERA_TESTNET]: Token.WETH[constants_1.ChainId.ZK_SYNC_ERA_TESTNET],
    };
