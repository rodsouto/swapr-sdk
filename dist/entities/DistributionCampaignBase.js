...
const MINIMUM_STAKED_AMOUNT_NATIVE_CURRENCY = {
    ...
    [constants_1.ChainId.BASE]: fractions_1.CurrencyAmount.nativeCurrency((0, units_1.parseUnits)('0.05', token_1.Token.getNative(constants_1.ChainId.BASE).decimals).toString(), constants_1.ChainId.BASE),
