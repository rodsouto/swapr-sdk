...
exports.DAI = {
    ...
    [constants_1.ChainId.SCROLL_MAINNET]: new token_1.Token(constants_1.ChainId.SCROLL_MAINNET, '0xcA77eB3fEFe3725Dc33bccB54eDEFc3D9f764f97', 18, 'DAI', 'Dai Token'),
};
exports.USDC = {
    [constants_1.ChainId.ARBITRUM_ONE]: new token_1.Token(constants_1.ChainId.ARBITRUM_ONE, '0xFF970A61A04b1cA14834A43f5dE4533eBDDB5CC8', 6, 'USDC.e', 'Bridged USDC'),
    ...
    [constants_1.ChainId.SCROLL_MAINNET]: new token_1.Token(constants_1.ChainId.SCROLL_MAINNET, '0x06eFdBFf2a14a7c8E15944D1F4A48F9F95F663A4', 6, 'USDC', 'USD Coin on zkSync Era Tesnet'),
    ...
    [constants_1.ChainId.ZK_SYNC_ERA_MAINNET]: new token_1.Token(constants_1.ChainId.ZK_SYNC_ERA_MAINNET, '0x3355df6D4c9C3035724Fd0e3914dE96A5a83aaf4', 6, 'USDC', 'USD Coin on zkSync Era'),
    [constants_1.ChainId.ZK_SYNC_ERA_TESTNET]: new token_1.Token(constants_1.ChainId.ZK_SYNC_ERA_TESTNET, '0x0faF6df7054946141266420b43783387A78d82A9', 6, 'USDC', 'USD Coin on zkSync Era Tesnet'),
};
exports.USDT = {
    ...
    [constants_1.ChainId.SCROLL_MAINNET]: new token_1.Token(constants_1.ChainId.SCROLL_MAINNET, '0xf55BEC9cafDbE8730f096Aa55dad6D22d44099Df', 6, 'USDT', 'Tether USD'),
...
exports.WBTC = {
    ...
    [constants_1.ChainId.POLYGON]: new token_1.Token(constants_1.ChainId.POLYGON, '0x1BFD67037B42Cf73acF2047067bd4F2C47D9BfD6', 8, 'WBTC', 'Wrapped BTC'),
    [constants_1.ChainId.SCROLL_MAINNET]: new token_1.Token(constants_1.ChainId.SCROLL_MAINNET, '0x3C1BCa5a656e69edCD0D4E36BEbb3FcDAcA60Cf1', 8, 'WBTC', 'Wrapped BTC'),
    [constants_1.ChainId.XDAI]: new token_1.Token(constants_1.ChainId.XDAI, '0x8e5bBbb09Ed1ebdE8674Cda39A0c169401db4252', 8, 'WBTC', 'Wrapped BTC'),
};
...
exports.BASES_TO_CHECK_TRADES_AGAINST = {
    ...
    [constants_1.ChainId.ZK_SYNC_ERA_MAINNET]: [exports.USDC[constants_1.ChainId.ZK_SYNC_ERA_MAINNET], token_1.WETH[constants_1.ChainId.ZK_SYNC_ERA_MAINNET]],
    [constants_1.ChainId.ZK_SYNC_ERA_TESTNET]: [exports.USDC[constants_1.ChainId.ZK_SYNC_ERA_TESTNET], token_1.WETH[constants_1.ChainId.ZK_SYNC_ERA_TESTNET]],
};
