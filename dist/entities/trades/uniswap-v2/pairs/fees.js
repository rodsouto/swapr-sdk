 ...
 */
async function getUniswapV2PairSwapFee({ pairAddressList, chainId, provider, }) {
    ...
    const swapFeeCallResults = (await multicallContract.callStatic.tryAggregate(false, pairAddressList.map((target) => ({ target, callData }))));
