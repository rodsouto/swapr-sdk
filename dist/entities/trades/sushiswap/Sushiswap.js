...
class SushiswapTrade extends trade_1.Trade {
    ...
    static async getQuote({ amount, quoteCurrency, tradeType, maximumSlippage = constants_2.maximumSlippage, recipient }, provider) {
        ...
        (0, tiny_invariant_1.default)((await provider.getNetwork()).chainId == chainId, `SushiswapTrade.getQuote: currencies chainId does not match provider's chainId`);
