...
const getPools = (currencyIn, currencyOut) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    const combinedResults = poolAddresses.flatMap((poolAddress) => {
        const liquidityResult = liquidityResults === null || liquidityResults === void 0 ? void 0 : liquidityResults.find(({ poolAddress: liquidityPoolAddress }) => liquidityPoolAddress === poolAddress.address);
        const globalSpaceResult = globalSpaceResults === null || globalSpaceResults === void 0 ? void 0 : globalSpaceResults.find(({ poolAddress: globalSpacePoolAddress }) => globalSpacePoolAddress === poolAddress.address);
