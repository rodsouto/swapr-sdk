...
exports.getMulticallContract = exports.getQuoterContract = exports.getRouterContract = exports.getPoolsContract = void 0;
...
function getMulticallContract() {
    return new contracts_1.Contract(constants_2.SWAPR_ALGEBRA_CONTRACTS.multicall, abi_1.SWAPR_ALGEBRA_MULTICALL_ABI, (0, utils_1.getProvider)(constants_1.ChainId.GNOSIS));
}
